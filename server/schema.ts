import { z } from 'zod';
import { EMOTIONS, GAZE_TARGETS, GESTURES, SCENE_IMAGE_NAME, SCENES, STATES, type AvatarCommand } from '../src/protocol.ts';
...
export const zScene = z.enum(SCENES);
export const zSceneImage = z.string().regex(SCENE_IMAGE_NAME);
...
export const zCommand = z.discriminatedUnion('type', [
  ...
  z.object({ type: z.literal('scene'), scene: zScene, image: zSceneImage.optional() }),
]);
